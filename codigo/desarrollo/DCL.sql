...
(
		IDRESPONSABLE 	CHAR(8) 		CONSTRAINT TIDRESPONSABLE_FK FOREIGN KEY(IDRESPONSABLE) REFERENCES RESPONSABLE,
		TELEFONO 		NUMBER(10) 		CONSTRAINT TELEFONO_NN NOT NULL
);
--EL ATRIBUTO MULTIVALUADO SE CREA COMO UNA ENTIDAD DEBIL
CREATE TABLE HORARIO
(
		IDRESPONSABLE 	CHAR(8) 		CONSTRAINT HIDRESPONSABLE_FK FOREIGN KEY(IDRESPONSABLE) REFERENCES RESPONSABLE,
...
(
		IDINSCRIPCION 	CHAR(8) 		CONSTRAINT IDINSCRIPCION_PK PRIMARY KEY(IDINSCRIPCION),
...
CREATE TABLE NIVEL
(
		IDNIVEL 		CHAR(8) 		CONSTRAINT IDNIVEL_PK PRIMARY KEY(IDNIVEL),
		NIVEL			NUMBER(2) 		CONSTRAINT NIVEL_NN NOT NULL
);


CREATE TABLE NIVEL_GRADO
(
		IDNIVEL 		CHAR(8) 		CONSTRAINT IDNIVEL_FK FOREIGN KEY(IDNIVEL) REFERENCES NIVEL,
		IDGRADO			CHAR(8),
...
CREATE TABLE GRUPO
(
		IDGRUPO 		CHAR(8) 		CONSTRAINT IDGRUPO_PK 	PRIMARY KEY(IDGRUPO),
...
(
		PRECIO 			NUMBER(8,2) 	CONSTRAINT PRECIO_NN NOT NULL,
		IDNIVEL 		CHAR(8),
		IDGRADO 		CHAR(8),
...
CREATE TABLE CARGO
(
	IDCARGO		CHAR(8) CONSTRAINT IDCARGO_PK PRIMARY KEY(IDCARGO),
	...
	IMPORTE 	NUMBER(11,2) CONSTRAINT IMPORTE_NN NOT NULL,
	ABONO 		NUMBER(11,2) CONSTRAINT ABONO_C DEFAULT 0,
	CVS 		CHAR(2)
);

CREATE TABLE DESCUENTO
(
	IDDESCUENTO 	CHAR(8)		 	CONSTRAINT IDDESCUENTO_PK PRIMARY KEY(IDDESCUENTO),
	FECHADESC 		DATE 			CONSTRAINT FECHADESC_NN NOT NULL,
	IMPORTE 		NUMBER(11,2) 	CONSTRAINT IMPORTE_D_NN NOT NULL,
	APLICADO 		CHAR(2) 		CONSTRAINT APLICADO_D DEFAULT 'NO'
);

ADD CODIGO DE PRUEBA
--ATRIBUTO DE CAMBIO