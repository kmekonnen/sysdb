...
(
		IDRESPONSABLE 	NUMBER(8) 		CONSTRAINT IDRESPONSABLE_PK PRIMARY KEY(IDRESPONSABLE),
...
(
	...
	IDRESPONSABLE 		NUMBER(8)			CONSTRAINT A_RIDRESPONSABLE_FK FOREIGN KEY(IDRESPONSABLE) REFERENCES IDRESPONSABLE
);
...
(
		IDSERVICIO 		NUMBER(8)		CONSTRAINT IDSERVICIO_PK 	PRIMARY KEY(IDSERVICIO),
...
(
	...
	CONSTRAINT CARGOAPLICADO_FK FOREIGN KEY(CARGOAPLICADO) REFRERENCES CARGO(IDCARGO),
	CONSTRAINT IDCARGO_FK FOREIGN KEY(IDCARGO) REFRERENCES CARGO(IDCARGO)
);
