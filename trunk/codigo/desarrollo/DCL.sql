...
(
	...
	CARGO 			NUMBER(8) 		CONSTRAINT CARGO_NN NOT NULL
	CARGOAPLICADO   NUMBER(8),
	CONSTRAINT CARGOAPLICADO_FK FOREIGN KEY REFRERENCES CARGO(IDCARGO),
	CONSTRAINT CARGO_FK FOREIGN KEY REFRERENCES CARGO(IDCARGO)
);
